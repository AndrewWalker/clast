...
void autogenerated_enums(pybind11::module& m)
{
    ...
    py::enum_<clang::Decl::Kind>(m.attr("Decl"), "clang_Decl_Kind")
        ...
        .value("Binding", clang::Decl::Kind::Binding)
        ...
        .value("Decomposition", clang::Decl::Kind::Decomposition)
    ...
    py::enum_<clang::Stmt::StmtClass>(m.attr("Stmt"), "clang_Stmt_StmtClass")
        ...
        .value("ObjCAvailabilityCheckExprClass", clang::Stmt::StmtClass::ObjCAvailabilityCheckExprClass)
        ...
        .value("OMPDistributeSimdDirectiveClass", clang::Stmt::StmtClass::OMPDistributeSimdDirectiveClass)
        ...
        .value("OMPTargetParallelForSimdDirectiveClass", clang::Stmt::StmtClass::OMPTargetParallelForSimdDirectiveClass)
        .value("OMPTargetSimdDirectiveClass", clang::Stmt::StmtClass::OMPTargetSimdDirectiveClass)
