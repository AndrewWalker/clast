...
void install_dyntypednode(pybind11::module& m) 
{
    py::class_<clatt::DynTypedNode>(m, "DynTypedNode")
        ...
        .def("_get_BindingDecl", &clatt::DynTypedNode::get<clang::BindingDecl>, py::return_value_policy::reference)
        .def("_get_DecompositionDecl", &clatt::DynTypedNode::get<clang::DecompositionDecl>, py::return_value_policy::reference)
        ...
        .def("_get_CXXInheritedCtorInitExpr", &clatt::DynTypedNode::get<clang::CXXInheritedCtorInitExpr>, py::return_value_policy::reference)
