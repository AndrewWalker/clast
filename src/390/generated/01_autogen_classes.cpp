...
void autogenerated_classes_0(pybind11::module& m)
{
    ...
    py::class_<clang::Decl, decl_deleter<clang::Decl>::type>(m, "Decl" )
        ...
        //.def("getDefiningAttr", (const clang::Attr * (clang::Decl::*)() const)&clang::Decl::getDefiningAttr , py::return_value_policy::reference_internal )
        ...
        .def("getDescribedTemplate", (clang::TemplateDecl * (clang::Decl::*)() const)&clang::Decl::getDescribedTemplate , py::return_value_policy::reference_internal )
    ...
    py::class_<clang::Type>(m, "Type" )
        ...
        .def("getPointeeOrArrayElementType", (const clang::Type * (clang::Type::*)() const)&clang::Type::getPointeeOrArrayElementType , py::return_value_policy::reference_internal )
    ...
    py::class_<clang::FunctionDecl, decl_deleter<clang::FunctionDecl>::type>(m, "FunctionDecl" , py::base<clang::DeclaratorDecl>())
        ...
        //.def("getUnusedResultAttr", (const clang::Attr * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getUnusedResultAttr , py::return_value_policy::reference_internal )
    ...
    py::class_<clang::TagDecl, decl_deleter<clang::TagDecl>::type>(m, "TagDecl" , py::base<clang::TypeDecl>())
        ...
        .def("getBraceRange", (clang::SourceRange (clang::TagDecl::*)() const)&clang::TagDecl::getBraceRange  )
        .def("setBraceRange", (void (clang::TagDecl::*)(clang::SourceRange))&clang::TagDecl::setBraceRange  )
    ...
    py::class_<clang::EnumDecl, decl_deleter<clang::EnumDecl>::type>(m, "EnumDecl" , py::base<clang::TagDecl>())
        ...
        .def("getTemplateInstantiationPattern", (clang::EnumDecl * (clang::EnumDecl::*)() const)&clang::EnumDecl::getTemplateInstantiationPattern , py::return_value_policy::reference_internal )
