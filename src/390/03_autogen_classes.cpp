...
void autogenerated_classes_2(pybind11::module& m)
{
    ...
    py::class_<clang::DesignatedInitExpr, stmt_deleter<clang::DesignatedInitExpr>::type>(m, "DesignatedInitExpr" , py::base<clang::Expr>())
        ...
        //  return self.designators();
        //})
        //.def("getDesignator", (clang::DesignatedInitExpr::Designator * (clang::DesignatedInitExpr::*)(unsigned int))&clang::DesignatedInitExpr::getDesignator)
        ...
        //.def("getArrayIndex", (clang::Expr * (clang::DesignatedInitExpr::*)(const clang::DesignatedInitExpr::Designator &) const)&clang::DesignatedInitExpr::getArrayIndex)
        //.def("getArrayRangeStart", (clang::Expr * (clang::DesignatedInitExpr::*)(const clang::DesignatedInitExpr::Designator &) const)&clang::DesignatedInitExpr::getArrayRangeStart)
        //.def("getArrayRangeEnd", (clang::Expr * (clang::DesignatedInitExpr::*)(const clang::DesignatedInitExpr::Designator &) const)&clang::DesignatedInitExpr::getArrayRangeEnd)
        ...
        .def("getInit", (clang::Expr * (clang::DesignatedInitExpr::*)() const)&clang::DesignatedInitExpr::getInit)
        ...
        .def("getSubExpr", (clang::Expr * (clang::DesignatedInitExpr::*)(unsigned int) const)&clang::DesignatedInitExpr::getSubExpr)
    ...
    py::class_<clang::DesignatedInitUpdateExpr, stmt_deleter<clang::DesignatedInitUpdateExpr>::type>(m, "DesignatedInitUpdateExpr" , py::base<clang::Expr>())
        ...
        .def("getBase", (clang::Expr * (clang::DesignatedInitUpdateExpr::*)() const)&clang::DesignatedInitUpdateExpr::getBase)
        .def("setBase", (void (clang::DesignatedInitUpdateExpr::*)(clang::Expr *))&clang::DesignatedInitUpdateExpr::setBase)
        .def("getUpdater", (clang::InitListExpr * (clang::DesignatedInitUpdateExpr::*)() const)&clang::DesignatedInitUpdateExpr::getUpdater)
    ...
    py::class_<clang::BlockExpr, stmt_deleter<clang::BlockExpr>::type>(m, "BlockExpr" , py::base<clang::Expr>())
        ...
        //.def("getFunctionType", (const clang::FunctionProtoType * (clang::BlockExpr::*)() const)&clang::BlockExpr::getFunctionType)
    ...
    py::class_<clang::AsTypeExpr, stmt_deleter<clang::AsTypeExpr>::type>(m, "AsTypeExpr" , py::base<clang::Expr>())
        ...
        .def("getSrcExpr", (clang::Expr * (clang::AsTypeExpr::*)() const)&clang::AsTypeExpr::getSrcExpr)
    ...
    py::class_<clang::AtomicExpr, stmt_deleter<clang::AtomicExpr>::type>(m, "AtomicExpr" , py::base<clang::Expr>())
        ...
        .def("getPtr", (clang::Expr * (clang::AtomicExpr::*)() const)&clang::AtomicExpr::getPtr)
        .def("getOrder", (clang::Expr * (clang::AtomicExpr::*)() const)&clang::AtomicExpr::getOrder)
        .def("getVal1", (clang::Expr * (clang::AtomicExpr::*)() const)&clang::AtomicExpr::getVal1)
        .def("getOrderFail", (clang::Expr * (clang::AtomicExpr::*)() const)&clang::AtomicExpr::getOrderFail)
        .def("getVal2", (clang::Expr * (clang::AtomicExpr::*)() const)&clang::AtomicExpr::getVal2)
        .def("getWeak", (clang::Expr * (clang::AtomicExpr::*)() const)&clang::AtomicExpr::getWeak)
    ...
    py::class_<clang::CXXRecordDecl, decl_deleter<clang::CXXRecordDecl>::type>(m, "CXXRecordDecl" , py::base<clang::RecordDecl>())
        ...
        .def("getDefinition", (clang::CXXRecordDecl * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getDefinition)
        ...
        .def("getLambdaCallOperator", (clang::CXXMethodDecl * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getLambdaCallOperator)
        .def("getLambdaStaticInvoker", (clang::CXXMethodDecl * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getLambdaStaticInvoker)
        //.def("getGenericLambdaTemplateParameterList", (clang::TemplateParameterList * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getGenericLambdaTemplateParameterList)
        ...
        .def("getInstantiatedFromMemberClass", (clang::CXXRecordDecl * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getInstantiatedFromMemberClass)
        //.def("getMemberSpecializationInfo", (clang::MemberSpecializationInfo * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getMemberSpecializationInfo)
        ...
        .def("getDescribedClassTemplate", (clang::ClassTemplateDecl * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getDescribedClassTemplate)
        ...
        .def("getDestructor", (clang::CXXDestructorDecl * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getDestructor)
        ...
        .def("getLambdaContextDecl", (clang::Decl * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getLambdaContextDecl)
        ...
        .def("getLambdaTypeInfo", (clang::TypeSourceInfo * (clang::CXXRecordDecl::*)() const)&clang::CXXRecordDecl::getLambdaTypeInfo)
    ;
    ...
    py::class_<clang::CXXConstructorDecl, decl_deleter<clang::CXXConstructorDecl>::type>(m, "CXXConstructorDecl" , py::base<clang::CXXMethodDecl>())
        ...
        .def("getTargetConstructor", (clang::CXXConstructorDecl * (clang::CXXConstructorDecl::*)() const)&clang::CXXConstructorDecl::getTargetConstructor)
    ...
    py::class_<clang::CXXDestructorDecl, decl_deleter<clang::CXXDestructorDecl>::type>(m, "CXXDestructorDecl" , py::base<clang::CXXMethodDecl>())
        ...
        .def("getOperatorDelete", (const clang::FunctionDecl * (clang::CXXDestructorDecl::*)() const)&clang::CXXDestructorDecl::getOperatorDelete)
    ;
    ...
    py::class_<clang::UsingDirectiveDecl, decl_deleter<clang::UsingDirectiveDecl>::type>(m, "UsingDirectiveDecl" , py::base<clang::NamedDecl>())
        ...
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::UsingDirectiveDecl::*)() const)&clang::UsingDirectiveDecl::getQualifier)
    ...
    py::class_<clang::NamespaceAliasDecl, decl_deleter<clang::NamespaceAliasDecl>::type>(m, "NamespaceAliasDecl" , py::base<clang::NamedDecl>())
        ...
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::NamespaceAliasDecl::*)() const)&clang::NamespaceAliasDecl::getQualifier)
        ...
        .def("getAliasedNamespace", (clang::NamedDecl * (clang::NamespaceAliasDecl::*)() const)&clang::NamespaceAliasDecl::getAliasedNamespace)
    ...
    py::class_<clang::UsingShadowDecl, decl_deleter<clang::UsingShadowDecl>::type>(m, "UsingShadowDecl" , py::base<clang::NamedDecl>())
        ...
        .def("getTargetDecl", (clang::NamedDecl * (clang::UsingShadowDecl::*)() const)&clang::UsingShadowDecl::getTargetDecl)
        .def("setTargetDecl", (void (clang::UsingShadowDecl::*)(clang::NamedDecl *))&clang::UsingShadowDecl::setTargetDecl)
        .def("getUsingDecl", (clang::UsingDecl * (clang::UsingShadowDecl::*)() const)&clang::UsingShadowDecl::getUsingDecl)
        .def("getNextUsingShadowDecl", (clang::UsingShadowDecl * (clang::UsingShadowDecl::*)() const)&clang::UsingShadowDecl::getNextUsingShadowDecl)
    ;
    ...
    py::class_<clang::UsingDecl, decl_deleter<clang::UsingDecl>::type>(m, "UsingDecl" , py::base<clang::NamedDecl>())
        ...
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::UsingDecl::*)() const)&clang::UsingDecl::getQualifier)
    ...
    py::class_<clang::UnresolvedUsingValueDecl, decl_deleter<clang::UnresolvedUsingValueDecl>::type>(m, "UnresolvedUsingValueDecl" , py::base<clang::ValueDecl>())
        ...
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::UnresolvedUsingValueDecl::*)() const)&clang::UnresolvedUsingValueDecl::getQualifier)
    ...
    py::class_<clang::UnresolvedUsingTypenameDecl, decl_deleter<clang::UnresolvedUsingTypenameDecl>::type>(m, "UnresolvedUsingTypenameDecl" , py::base<clang::TypeDecl>())
        ...
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::UnresolvedUsingTypenameDecl::*)() const)&clang::UnresolvedUsingTypenameDecl::getQualifier)
    ...
    py::class_<clang::MSPropertyDecl, decl_deleter<clang::MSPropertyDecl>::type>(m, "MSPropertyDecl" , py::base<clang::DeclaratorDecl>())
        ...
        //.def("getGetterId", (clang::IdentifierInfo * (clang::MSPropertyDecl::*)() const)&clang::MSPropertyDecl::getGetterId)
        .def("hasSetter", (bool (clang::MSPropertyDecl::*)() const)&clang::MSPropertyDecl::hasSetter)
        //.def("getSetterId", (clang::IdentifierInfo * (clang::MSPropertyDecl::*)() const)&clang::MSPropertyDecl::getSetterId)
    ;

    py::class_<clang::TemplateDecl, decl_deleter<clang::TemplateDecl>::type>(m, "TemplateDecl" , py::base<clang::NamedDecl>())

        //.def("getTemplateParameters", (clang::TemplateParameterList * (clang::TemplateDecl::*)() const)&clang::TemplateDecl::getTemplateParameters)
        .def("getTemplatedDecl", (clang::NamedDecl * (clang::TemplateDecl::*)() const)&clang::TemplateDecl::getTemplatedDecl)
    ...
    py::class_<clang::RedeclarableTemplateDecl, decl_deleter<clang::RedeclarableTemplateDecl>::type>(m, "RedeclarableTemplateDecl" , py::base<clang::TemplateDecl>())
        ...
        .def("getInstantiatedFromMemberTemplate", (clang::RedeclarableTemplateDecl * (clang::RedeclarableTemplateDecl::*)() const)&clang::RedeclarableTemplateDecl::getInstantiatedFromMemberTemplate)
    ...
    py::class_<clang::FunctionTemplateDecl, decl_deleter<clang::FunctionTemplateDecl>::type>(m, "FunctionTemplateDecl" , py::base<clang::RedeclarableTemplateDecl>())
        ...
        .def("getTemplatedDecl", (clang::FunctionDecl * (clang::FunctionTemplateDecl::*)() const)&clang::FunctionTemplateDecl::getTemplatedDecl)
        ...
        .def("getInstantiatedFromMemberTemplate", (clang::FunctionTemplateDecl * (clang::FunctionTemplateDecl::*)() const)&clang::FunctionTemplateDecl::getInstantiatedFromMemberTemplate)
    ...
    py::class_<clang::TemplateTypeParmDecl, decl_deleter<clang::TemplateTypeParmDecl>::type>(m, "TemplateTypeParmDecl" , py::base<clang::TypeDecl>())
        ...
        .def("getDefaultArgumentInfo", (clang::TypeSourceInfo * (clang::TemplateTypeParmDecl::*)() const)&clang::TemplateTypeParmDecl::getDefaultArgumentInfo)
    ...
    py::class_<clang::NonTypeTemplateParmDecl, decl_deleter<clang::NonTypeTemplateParmDecl>::type>(m, "NonTypeTemplateParmDecl" , py::base<clang::DeclaratorDecl>())
        ...
        .def("getDefaultArgument", (clang::Expr * (clang::NonTypeTemplateParmDecl::*)() const)&clang::NonTypeTemplateParmDecl::getDefaultArgument)
        ...
        .def("getExpansionTypeSourceInfo", (clang::TypeSourceInfo * (clang::NonTypeTemplateParmDecl::*)(unsigned int) const)&clang::NonTypeTemplateParmDecl::getExpansionTypeSourceInfo)
    ;
    ...
    py::class_<clang::TemplateTemplateParmDecl, decl_deleter<clang::TemplateTemplateParmDecl>::type>(m, "TemplateTemplateParmDecl" , py::base<clang::TemplateDecl>())
        ...
        //.def("getExpansionTemplateParameters", (clang::TemplateParameterList * (clang::TemplateTemplateParmDecl::*)(unsigned int) const)&clang::TemplateTemplateParmDecl::getExpansionTemplateParameters)
    ...
    py::class_<clang::ClassTemplateSpecializationDecl, decl_deleter<clang::ClassTemplateSpecializationDecl>::type>(m, "ClassTemplateSpecializationDecl" , py::base<clang::CXXRecordDecl>())
        ...
        .def("getMostRecentDecl", (clang::ClassTemplateSpecializationDecl * (clang::ClassTemplateSpecializationDecl::*)())&clang::ClassTemplateSpecializationDecl::getMostRecentDecl)
        .def("getSpecializedTemplate", (clang::ClassTemplateDecl * (clang::ClassTemplateSpecializationDecl::*)() const)&clang::ClassTemplateSpecializationDecl::getSpecializedTemplate)
        ...
        .def("getTypeAsWritten", (clang::TypeSourceInfo * (clang::ClassTemplateSpecializationDecl::*)() const)&clang::ClassTemplateSpecializationDecl::getTypeAsWritten)
    ...
    py::class_<clang::ClassTemplatePartialSpecializationDecl, decl_deleter<clang::ClassTemplatePartialSpecializationDecl>::type>(m, "ClassTemplatePartialSpecializationDecl" , py::base<clang::ClassTemplateSpecializationDecl>())
        ...
        .def("getMostRecentDecl", (clang::ClassTemplatePartialSpecializationDecl * (clang::ClassTemplatePartialSpecializationDecl::*)())&clang::ClassTemplatePartialSpecializationDecl::getMostRecentDecl)
        //.def("getTemplateParameters", (clang::TemplateParameterList * (clang::ClassTemplatePartialSpecializationDecl::*)() const)&clang::ClassTemplatePartialSpecializationDecl::getTemplateParameters)
        //.def("getTemplateArgsAsWritten", (const clang::ASTTemplateArgumentListInfo * (clang::ClassTemplatePartialSpecializationDecl::*)() const)&clang::ClassTemplatePartialSpecializationDecl::getTemplateArgsAsWritten)
        .def("getInstantiatedFromMember", (clang::ClassTemplatePartialSpecializationDecl * (clang::ClassTemplatePartialSpecializationDecl::*)() const)&clang::ClassTemplatePartialSpecializationDecl::getInstantiatedFromMember)
        .def("getInstantiatedFromMemberTemplate", (clang::ClassTemplatePartialSpecializationDecl * (clang::ClassTemplatePartialSpecializationDecl::*)() const)&clang::ClassTemplatePartialSpecializationDecl::getInstantiatedFromMemberTemplate)
    ...
    py::class_<clang::ClassTemplateDecl, decl_deleter<clang::ClassTemplateDecl>::type>(m, "ClassTemplateDecl" , py::base<clang::RedeclarableTemplateDecl>())
        ...
        .def("getTemplatedDecl", (clang::CXXRecordDecl * (clang::ClassTemplateDecl::*)() const)&clang::ClassTemplateDecl::getTemplatedDecl)
        ...
        .def("getInstantiatedFromMemberTemplate", (clang::ClassTemplateDecl * (clang::ClassTemplateDecl::*)() const)&clang::ClassTemplateDecl::getInstantiatedFromMemberTemplate)
        ...
        .def("findPartialSpecInstantiatedFromMember", (clang::ClassTemplatePartialSpecializationDecl * (clang::ClassTemplateDecl::*)(clang::ClassTemplatePartialSpecializationDecl *))&clang::ClassTemplateDecl::findPartialSpecInstantiatedFromMember)
    ...
    py::class_<clang::FriendTemplateDecl, decl_deleter<clang::FriendTemplateDecl>::type>(m, "FriendTemplateDecl" , py::base<clang::Decl>())
        ...
        .def("getFriendType", (clang::TypeSourceInfo * (clang::FriendTemplateDecl::*)() const)&clang::FriendTemplateDecl::getFriendType)
        .def("getFriendDecl", (clang::NamedDecl * (clang::FriendTemplateDecl::*)() const)&clang::FriendTemplateDecl::getFriendDecl)
        .def("getFriendLoc", (clang::SourceLocation (clang::FriendTemplateDecl::*)() const)&clang::FriendTemplateDecl::getFriendLoc)
        //.def("getTemplateParameterList", (clang::TemplateParameterList * (clang::FriendTemplateDecl::*)(unsigned int) const)&clang::FriendTemplateDecl::getTemplateParameterList)
    ...
    py::class_<clang::TypeAliasTemplateDecl, decl_deleter<clang::TypeAliasTemplateDecl>::type>(m, "TypeAliasTemplateDecl" , py::base<clang::RedeclarableTemplateDecl>())
        ...
        .def("getTemplatedDecl", (clang::TypeAliasDecl * (clang::TypeAliasTemplateDecl::*)() const)&clang::TypeAliasTemplateDecl::getTemplatedDecl)
        ...
        .def("getInstantiatedFromMemberTemplate", (clang::TypeAliasTemplateDecl * (clang::TypeAliasTemplateDecl::*)() const)&clang::TypeAliasTemplateDecl::getInstantiatedFromMemberTemplate)
    ;
    ...
    py::class_<clang::ClassScopeFunctionSpecializationDecl, decl_deleter<clang::ClassScopeFunctionSpecializationDecl>::type>(m, "ClassScopeFunctionSpecializationDecl" , py::base<clang::Decl>())
        ...
        .def("getSpecialization", (clang::CXXMethodDecl * (clang::ClassScopeFunctionSpecializationDecl::*)() const)&clang::ClassScopeFunctionSpecializationDecl::getSpecialization)
    ...
    py::class_<clang::VarTemplateSpecializationDecl, decl_deleter<clang::VarTemplateSpecializationDecl>::type>(m, "VarTemplateSpecializationDecl" , py::base<clang::VarDecl>())
        ...
        .def("getMostRecentDecl", (clang::VarTemplateSpecializationDecl * (clang::VarTemplateSpecializationDecl::*)())&clang::VarTemplateSpecializationDecl::getMostRecentDecl)
        .def("getSpecializedTemplate", (clang::VarTemplateDecl * (clang::VarTemplateSpecializationDecl::*)() const)&clang::VarTemplateSpecializationDecl::getSpecializedTemplate)
        ...
        .def("getTypeAsWritten", (clang::TypeSourceInfo * (clang::VarTemplateSpecializationDecl::*)() const)&clang::VarTemplateSpecializationDecl::getTypeAsWritten)
    ...
    py::class_<clang::VarTemplatePartialSpecializationDecl, decl_deleter<clang::VarTemplatePartialSpecializationDecl>::type>(m, "VarTemplatePartialSpecializationDecl" , py::base<clang::VarTemplateSpecializationDecl>())
        ...
        .def("getMostRecentDecl", (clang::VarTemplatePartialSpecializationDecl * (clang::VarTemplatePartialSpecializationDecl::*)())&clang::VarTemplatePartialSpecializationDecl::getMostRecentDecl)
        //.def("getTemplateParameters", (clang::TemplateParameterList * (clang::VarTemplatePartialSpecializationDecl::*)() const)&clang::VarTemplatePartialSpecializationDecl::getTemplateParameters)
        //.def("getTemplateArgsAsWritten", (const clang::ASTTemplateArgumentListInfo * (clang::VarTemplatePartialSpecializationDecl::*)() const)&clang::VarTemplatePartialSpecializationDecl::getTemplateArgsAsWritten)
        .def("getInstantiatedFromMember", (clang::VarTemplatePartialSpecializationDecl * (clang::VarTemplatePartialSpecializationDecl::*)() const)&clang::VarTemplatePartialSpecializationDecl::getInstantiatedFromMember)
    ...
    py::class_<clang::VarTemplateDecl, decl_deleter<clang::VarTemplateDecl>::type>(m, "VarTemplateDecl" , py::base<clang::RedeclarableTemplateDecl>())
        ...
        .def("getTemplatedDecl", (clang::VarDecl * (clang::VarTemplateDecl::*)() const)&clang::VarTemplateDecl::getTemplatedDecl)
        .def("isThisDeclarationADefinition", (bool (clang::VarTemplateDecl::*)() const)&clang::VarTemplateDecl::isThisDeclarationADefinition)
        .def("getDefinition", (clang::VarTemplateDecl * (clang::VarTemplateDecl::*)())&clang::VarTemplateDecl::getDefinition)
        ...
        .def("getInstantiatedFromMemberTemplate", (clang::VarTemplateDecl * (clang::VarTemplateDecl::*)() const)&clang::VarTemplateDecl::getInstantiatedFromMemberTemplate)
        ...
        //   self.getPartialSpecializations(PS);
        //})
        .def("findPartialSpecInstantiatedFromMember", (clang::VarTemplatePartialSpecializationDecl * (clang::VarTemplateDecl::*)(clang::VarTemplatePartialSpecializationDecl *))&clang::VarTemplateDecl::findPartialSpecInstantiatedFromMember)
    ...
    py::class_<clang::CXXMemberCallExpr, stmt_deleter<clang::CXXMemberCallExpr>::type>(m, "CXXMemberCallExpr" , py::base<clang::CallExpr>())
        ...
        .def("getImplicitObjectArgument", (clang::Expr * (clang::CXXMemberCallExpr::*)() const)&clang::CXXMemberCallExpr::getImplicitObjectArgument)
        .def("getMethodDecl", (clang::CXXMethodDecl * (clang::CXXMemberCallExpr::*)() const)&clang::CXXMemberCallExpr::getMethodDecl)
        .def("getRecordDecl", (clang::CXXRecordDecl * (clang::CXXMemberCallExpr::*)() const)&clang::CXXMemberCallExpr::getRecordDecl)
    ...
    py::class_<clang::CXXNamedCastExpr, stmt_deleter<clang::CXXNamedCastExpr>::type>(m, "CXXNamedCastExpr" , py::base<clang::ExplicitCastExpr>())
        ...
        .def("getLocStart", (clang::SourceLocation (clang::CXXNamedCastExpr::*)() const)&clang::CXXNamedCastExpr::getLocStart)
        .def("getLocEnd", (clang::SourceLocation (clang::CXXNamedCastExpr::*)() const)&clang::CXXNamedCastExpr::getLocEnd)
