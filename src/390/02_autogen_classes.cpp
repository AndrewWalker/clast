...
void autogenerated_classes_1(pybind11::module& m)
{
    ...
    py::class_<clang::WhileStmt, stmt_deleter<clang::WhileStmt>::type>(m, "WhileStmt" , py::base<clang::Stmt>())
        ...
        .def("getConditionVariable", (clang::VarDecl * (clang::WhileStmt::*)() const)&clang::WhileStmt::getConditionVariable)
        .def("setConditionVariable", (void (clang::WhileStmt::*)(const clang::ASTContext &, clang::VarDecl *))&clang::WhileStmt::setConditionVariable)
        .def("getConditionVariableDeclStmt", (const clang::DeclStmt * (clang::WhileStmt::*)() const)&clang::WhileStmt::getConditionVariableDeclStmt)
    ...
    py::class_<clang::ASTContext>(m, "ASTContext" )
        ...
        .def("getTypePackElementDecl", (clang::BuiltinTemplateDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getTypePackElementDecl)
        ...
        .def("getCFConstantStringDecl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getCFConstantStringDecl)
        .def("getCFConstantStringTagDecl", (clang::RecordDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getCFConstantStringTagDecl)
        ...
        //.def("getBoolName", (clang::IdentifierInfo * (clang::ASTContext::*)() const)&clang::ASTContext::getBoolName)
        //.def("getMakeIntegerSeqName", (clang::IdentifierInfo * (clang::ASTContext::*)() const)&clang::ASTContext::getMakeIntegerSeqName)
        //.def("getTypePackElementName", (clang::IdentifierInfo * (clang::ASTContext::*)() const)&clang::ASTContext::getTypePackElementName)
