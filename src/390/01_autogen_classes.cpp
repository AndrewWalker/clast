...
//  Clang - clang version 3.9.0-svn275525-1~exp1 (trunk)
//
...
void autogenerated_classes_0(pybind11::module& m)
{
    ...
    py::class_<clang::DeclarationName>(m, "DeclarationName" )
        ...
        //.def("getAsIdentifierInfo", (clang::IdentifierInfo * (clang::DeclarationName::*)() const)&clang::DeclarationName::getAsIdentifierInfo)
        ...
        //.def("getCXXLiteralIdentifier", (clang::IdentifierInfo * (clang::DeclarationName::*)() const)&clang::DeclarationName::getCXXLiteralIdentifier)
        ...
        //.def("print", (void (clang::DeclarationName::*)(llvm::raw_ostream &, const clang::PrintingPolicy &))&clang::DeclarationName::print)
    ...
    py::class_<clang::DeclarationNameInfo>(m, "DeclarationNameInfo" )
        ...
        .def("getNamedTypeInfo", (clang::TypeSourceInfo * (clang::DeclarationNameInfo::*)() const)&clang::DeclarationNameInfo::getNamedTypeInfo)
    ...
    py::class_<clang::Decl, decl_deleter<clang::Decl>::type>(m, "Decl" )
        ...
        .def("hasDefiningAttr", (bool (clang::Decl::*)() const)&clang::Decl::hasDefiningAttr)
        //.def("getDefiningAttr", (const clang::Attr * (clang::Decl::*)() const)&clang::Decl::getDefiningAttr)
        ...
        //.def("getImportedOwningModule", (clang::Module * (clang::Decl::*)() const)&clang::Decl::getImportedOwningModule)
        //.def("getLocalOwningModule", (clang::Module * (clang::Decl::*)() const)&clang::Decl::getLocalOwningModule)
        ...
        .def("getBody", (clang::Stmt * (clang::Decl::*)() const)&clang::Decl::getBody)
        ...
        .def("getDescribedTemplate", (clang::TemplateDecl * (clang::Decl::*)() const)&clang::Decl::getDescribedTemplate)
        ...
        //   self.dump(Out);
        //})
        //.def("getFunctionType", (const clang::FunctionType * (clang::Decl::*)(bool) const)&clang::Decl::getFunctionType)
    ;
    ...
    py::class_<clang::DeclContext>(m, "DeclContext" )
        ...
        //.def("getLookupPtr", (clang::StoredDeclsMap * (clang::DeclContext::*)() const)&clang::DeclContext::getLookupPtr)
        //.def("buildLookup", (clang::StoredDeclsMap * (clang::DeclContext::*)())&clang::DeclContext::buildLookup)
    ...
    py::class_<clang::Qualifiers>(m, "Qualifiers" )
        ...
        .def("addCVRUQualifiers", (void (clang::Qualifiers::*)(unsigned int))&clang::Qualifiers::addCVRUQualifiers)
        .def("hasUnaligned", (bool (clang::Qualifiers::*)() const)&clang::Qualifiers::hasUnaligned)
        .def("setUnaligned", (void (clang::Qualifiers::*)(bool))&clang::Qualifiers::setUnaligned)
        .def("removeUnaligned", (void (clang::Qualifiers::*)())&clang::Qualifiers::removeUnaligned)
        .def("addUnaligned", (void (clang::Qualifiers::*)())&clang::Qualifiers::addUnaligned)
    ...
    py::class_<clang::QualType>(m, "QualType" )
        ...
        .def("getTypePtr", (const clang::Type * (clang::QualType::*)() const)&clang::QualType::getTypePtr)
        .def("getTypePtrOrNull", (const clang::Type * (clang::QualType::*)() const)&clang::QualType::getTypePtrOrNull)
        //.def("getBaseTypeIdentifier", (const clang::IdentifierInfo * (clang::QualType::*)() const)&clang::QualType::getBaseTypeIdentifier)
        ...
        .def("isConstant", [](const clang::QualType& self, const clang::ASTContext & Ctx) -> bool {
          return self.isConstant(Ctx);
        })
        .def("isPODType", (bool (clang::QualType::*)(const clang::ASTContext &) const)&clang::QualType::isPODType)
        .def("isCXX98PODType", (bool (clang::QualType::*)(const clang::ASTContext &) const)&clang::QualType::isCXX98PODType)
        .def("isCXX11PODType", (bool (clang::QualType::*)(const clang::ASTContext &) const)&clang::QualType::isCXX11PODType)
        .def("isTrivialType", (bool (clang::QualType::*)(const clang::ASTContext &) const)&clang::QualType::isTrivialType)
        .def("isTriviallyCopyableType", (bool (clang::QualType::*)(const clang::ASTContext &) const)&clang::QualType::isTriviallyCopyableType)
        ...
        //})
        //.def("stream", (clang::QualType::StreamedQualTypeHelper (clang::QualType::*)(const clang::PrintingPolicy &, const llvm::Twine &, unsigned int) const)&clang::QualType::stream)
        ...
        .def("getAtomicUnqualifiedType", (clang::QualType (clang::QualType::*)() const)&clang::QualType::getAtomicUnqualifiedType)
    ;
    ...
    py::class_<clang::Type>(m, "Type" )
        ...
        //.def("getAsPlaceholderType", (const clang::BuiltinType * (clang::Type::*)() const)&clang::Type::getAsPlaceholderType)
        ...
        .def("isIntegralType", (bool (clang::Type::*)(const clang::ASTContext &) const)&clang::Type::isIntegralType)
        ...
        .def("isOCLImage1dROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dROType)
        .def("isOCLImage1dArrayROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dArrayROType)
        .def("isOCLImage1dBufferROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dBufferROType)
        .def("isOCLImage2dROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dROType)
        .def("isOCLImage2dArrayROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayROType)
        .def("isOCLImage2dDepthROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dDepthROType)
        .def("isOCLImage2dArrayDepthROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayDepthROType)
        .def("isOCLImage2dMSAAROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dMSAAROType)
        .def("isOCLImage2dArrayMSAAROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayMSAAROType)
        .def("isOCLImage2dMSAADepthROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dMSAADepthROType)
        .def("isOCLImage2dArrayMSAADepthROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayMSAADepthROType)
        .def("isOCLImage3dROType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage3dROType)
        .def("isOCLImage1dWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dWOType)
        .def("isOCLImage1dArrayWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dArrayWOType)
        .def("isOCLImage1dBufferWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dBufferWOType)
        .def("isOCLImage2dWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dWOType)
        .def("isOCLImage2dArrayWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayWOType)
        .def("isOCLImage2dDepthWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dDepthWOType)
        .def("isOCLImage2dArrayDepthWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayDepthWOType)
        .def("isOCLImage2dMSAAWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dMSAAWOType)
        .def("isOCLImage2dArrayMSAAWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayMSAAWOType)
        .def("isOCLImage2dMSAADepthWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dMSAADepthWOType)
        .def("isOCLImage2dArrayMSAADepthWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayMSAADepthWOType)
        .def("isOCLImage3dWOType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage3dWOType)
        .def("isOCLImage1dRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dRWType)
        .def("isOCLImage1dArrayRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dArrayRWType)
        .def("isOCLImage1dBufferRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage1dBufferRWType)
        .def("isOCLImage2dRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dRWType)
        .def("isOCLImage2dArrayRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayRWType)
        .def("isOCLImage2dDepthRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dDepthRWType)
        .def("isOCLImage2dArrayDepthRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayDepthRWType)
        .def("isOCLImage2dMSAARWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dMSAARWType)
        .def("isOCLImage2dArrayMSAARWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayMSAARWType)
        .def("isOCLImage2dMSAADepthRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dMSAADepthRWType)
        .def("isOCLImage2dArrayMSAADepthRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage2dArrayMSAADepthRWType)
        .def("isOCLImage3dRWType", (bool (clang::Type::*)() const)&clang::Type::isOCLImage3dRWType)
        ...
        //.def("getAsStructureType", (const clang::RecordType * (clang::Type::*)() const)&clang::Type::getAsStructureType)
        //.def("getAsUnionType", (const clang::RecordType * (clang::Type::*)() const)&clang::Type::getAsUnionType)
        //.def("getAsComplexIntegerType", (const clang::ComplexType * (clang::Type::*)() const)&clang::Type::getAsComplexIntegerType)
        //.def("getAsObjCInterfaceType", (const clang::ObjCObjectType * (clang::Type::*)() const)&clang::Type::getAsObjCInterfaceType)
        //.def("getAsObjCInterfacePointerType", (const clang::ObjCObjectPointerType * (clang::Type::*)() const)&clang::Type::getAsObjCInterfacePointerType)
        //.def("getAsObjCQualifiedIdType", (const clang::ObjCObjectPointerType * (clang::Type::*)() const)&clang::Type::getAsObjCQualifiedIdType)
        //.def("getAsObjCQualifiedClassType", (const clang::ObjCObjectPointerType * (clang::Type::*)() const)&clang::Type::getAsObjCQualifiedClassType)
        //.def("getAsObjCQualifiedInterfaceType", (const clang::ObjCObjectType * (clang::Type::*)() const)&clang::Type::getAsObjCQualifiedInterfaceType)
        .def("getAsCXXRecordDecl", (clang::CXXRecordDecl * (clang::Type::*)() const)&clang::Type::getAsCXXRecordDecl)
        .def("getAsTagDecl", (clang::TagDecl * (clang::Type::*)() const)&clang::Type::getAsTagDecl)
        .def("getPointeeCXXRecordDecl", (const clang::CXXRecordDecl * (clang::Type::*)() const)&clang::Type::getPointeeCXXRecordDecl)
        //.def("getContainedAutoType", (clang::AutoType * (clang::Type::*)() const)&clang::Type::getContainedAutoType)
        //.def("getAsArrayTypeUnsafe", (const clang::ArrayType * (clang::Type::*)() const)&clang::Type::getAsArrayTypeUnsafe)
        //.def("castAsArrayTypeUnsafe", (const clang::ArrayType * (clang::Type::*)() const)&clang::Type::castAsArrayTypeUnsafe)
        .def("getBaseElementTypeUnsafe", (const clang::Type * (clang::Type::*)() const)&clang::Type::getBaseElementTypeUnsafe)
        .def("getArrayElementTypeNoTypeQual", (const clang::Type * (clang::Type::*)() const)&clang::Type::getArrayElementTypeNoTypeQual)
        .def("getPointeeOrArrayElementType", (const clang::Type * (clang::Type::*)() const)&clang::Type::getPointeeOrArrayElementType)
        .def("getPointeeType", (clang::QualType (clang::Type::*)() const)&clang::Type::getPointeeType)
        .def("getUnqualifiedDesugaredType", (const clang::Type * (clang::Type::*)() const)&clang::Type::getUnqualifiedDesugaredType)
    ...
    py::class_<clang::TranslationUnitDecl, decl_deleter<clang::TranslationUnitDecl>::type>(m, "TranslationUnitDecl" , py::base<clang::Decl>())
        ...
        .def("getAnonymousNamespace", (clang::NamespaceDecl * (clang::TranslationUnitDecl::*)() const)&clang::TranslationUnitDecl::getAnonymousNamespace)
    ...
    py::class_<clang::PragmaCommentDecl, decl_deleter<clang::PragmaCommentDecl>::type>(m, "PragmaCommentDecl" , py::base<clang::Decl>())
        ...
        .def("getCommentKind", (clang::PragmaMSCommentKind (clang::PragmaCommentDecl::*)() const)&clang::PragmaCommentDecl::getCommentKind)
        .def("getArg", (llvm::StringRef (clang::PragmaCommentDecl::*)() const)&clang::PragmaCommentDecl::getArg)
    ;
    ...
    py::class_<clang::PragmaDetectMismatchDecl, decl_deleter<clang::PragmaDetectMismatchDecl>::type>(m, "PragmaDetectMismatchDecl" , py::base<clang::Decl>())
        ...
        .def("getName", (llvm::StringRef (clang::PragmaDetectMismatchDecl::*)() const)&clang::PragmaDetectMismatchDecl::getName)
        .def("getValue", (llvm::StringRef (clang::PragmaDetectMismatchDecl::*)() const)&clang::PragmaDetectMismatchDecl::getValue)
    ;
    ...
    py::class_<clang::NamedDecl, decl_deleter<clang::NamedDecl>::type>(m, "NamedDecl" , py::base<clang::Decl>())
        ...
        //.def("getIdentifier", (clang::IdentifierInfo * (clang::NamedDecl::*)() const)&clang::NamedDecl::getIdentifier)
    ...
    py::class_<clang::LabelDecl, decl_deleter<clang::LabelDecl>::type>(m, "LabelDecl" , py::base<clang::NamedDecl>())
        ...
        .def("getStmt", (clang::LabelStmt * (clang::LabelDecl::*)() const)&clang::LabelDecl::getStmt)
    ...
    py::class_<clang::NamespaceDecl, decl_deleter<clang::NamespaceDecl>::type>(m, "NamespaceDecl" , py::base<clang::NamedDecl>())
        ...
        .def("getAnonymousNamespace", (clang::NamespaceDecl * (clang::NamespaceDecl::*)() const)&clang::NamespaceDecl::getAnonymousNamespace)
    ...
    py::class_<clang::DeclaratorDecl, decl_deleter<clang::DeclaratorDecl>::type>(m, "DeclaratorDecl" , py::base<clang::ValueDecl>())
        ...
        .def("getTypeSourceInfo", (clang::TypeSourceInfo * (clang::DeclaratorDecl::*)() const)&clang::DeclaratorDecl::getTypeSourceInfo)
        ...
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::DeclaratorDecl::*)() const)&clang::DeclaratorDecl::getQualifier)
        ...
        //.def("getTemplateParameterList", (clang::TemplateParameterList * (clang::DeclaratorDecl::*)(unsigned int) const)&clang::DeclaratorDecl::getTemplateParameterList)
    ...
    py::class_<clang::VarDecl, decl_deleter<clang::VarDecl>::type>(m, "VarDecl" , py::base<clang::DeclaratorDecl>())
        ...
        //.def("ensureEvaluatedStmt", (clang::EvaluatedStmt * (clang::VarDecl::*)() const)&clang::VarDecl::ensureEvaluatedStmt)
        ...
        //})
        //.def("getEvaluatedValue", (clang::APValue * (clang::VarDecl::*)() const)&clang::VarDecl::getEvaluatedValue)
        ...
        .def("isInline", (bool (clang::VarDecl::*)() const)&clang::VarDecl::isInline)
        .def("isInlineSpecified", (bool (clang::VarDecl::*)() const)&clang::VarDecl::isInlineSpecified)
        .def("setInlineSpecified", (void (clang::VarDecl::*)())&clang::VarDecl::setInlineSpecified)
        .def("setImplicitlyInline", (void (clang::VarDecl::*)())&clang::VarDecl::setImplicitlyInline)
        ...
        .def("getInstantiatedFromStaticDataMember", (clang::VarDecl * (clang::VarDecl::*)() const)&clang::VarDecl::getInstantiatedFromStaticDataMember)
        ...
        //.def("getMemberSpecializationInfo", (clang::MemberSpecializationInfo * (clang::VarDecl::*)() const)&clang::VarDecl::getMemberSpecializationInfo)
        ...
        .def("getDescribedVarTemplate", (clang::VarTemplateDecl * (clang::VarDecl::*)() const)&clang::VarDecl::getDescribedVarTemplate)
    ...
    py::class_<clang::FunctionDecl, decl_deleter<clang::FunctionDecl>::type>(m, "FunctionDecl" , py::base<clang::DeclaratorDecl>())
        ...
        .def("getDefinition", []( clang::FunctionDecl& self) -> clang::FunctionDecl * {
          return self.getDefinition();
        })
        .def("getDefinition", [](const clang::FunctionDecl& self) -> const clang::FunctionDecl * {
          return self.getDefinition();
        })
        ...
        //})
        //.def("parameters", []( clang::FunctionDecl& self) -> llvm::MutableArrayRef<clang::ParmVarDecl *> {
        //  return self.parameters();
        //})
        .def("param_empty", (bool (clang::FunctionDecl::*)() const)&clang::FunctionDecl::param_empty)
        .def("param_size", (unsigned long (clang::FunctionDecl::*)() const)&clang::FunctionDecl::param_size)
        ...
        //.def("getUnusedResultAttr", (const clang::Attr * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getUnusedResultAttr)
        ...
        //.def("getLiteralIdentifier", (const clang::IdentifierInfo * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getLiteralIdentifier)
        .def("getInstantiatedFromMemberFunction", (clang::FunctionDecl * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getInstantiatedFromMemberFunction)
        .def("getTemplatedKind", (clang::FunctionDecl::TemplatedKind (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getTemplatedKind)
        //.def("getMemberSpecializationInfo", (clang::MemberSpecializationInfo * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getMemberSpecializationInfo)
        ...
        .def("getDescribedFunctionTemplate", (clang::FunctionTemplateDecl * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getDescribedFunctionTemplate)
        ...
        .def("getClassScopeSpecializationPattern", (clang::FunctionDecl * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getClassScopeSpecializationPattern)
        //.def("getTemplateSpecializationInfo", (clang::FunctionTemplateSpecializationInfo * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getTemplateSpecializationInfo)
        ...
        .def("getTemplateInstantiationPattern", (clang::FunctionDecl * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getTemplateInstantiationPattern)
        .def("getPrimaryTemplate", (clang::FunctionTemplateDecl * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getPrimaryTemplate)
        //.def("getTemplateSpecializationArgs", (const clang::TemplateArgumentList * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getTemplateSpecializationArgs)
        //.def("getTemplateSpecializationArgsAsWritten", (const clang::ASTTemplateArgumentListInfo * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getTemplateSpecializationArgsAsWritten)
        ...
        //.def("getDependentSpecializationInfo", (clang::DependentFunctionTemplateSpecializationInfo * (clang::FunctionDecl::*)() const)&clang::FunctionDecl::getDependentSpecializationInfo)
    ...
    py::class_<clang::FieldDecl, decl_deleter<clang::FieldDecl>::type>(m, "FieldDecl" , py::base<clang::DeclaratorDecl>())
        ...
        .def("getBitWidth", (clang::Expr * (clang::FieldDecl::*)() const)&clang::FieldDecl::getBitWidth)
        ...
        .def("getInClassInitializer", (clang::Expr * (clang::FieldDecl::*)() const)&clang::FieldDecl::getInClassInitializer)
        ...
        //.def("getCapturedVLAType", (const clang::VariableArrayType * (clang::FieldDecl::*)() const)&clang::FieldDecl::getCapturedVLAType)
    ...
    py::class_<clang::IndirectFieldDecl, decl_deleter<clang::IndirectFieldDecl>::type>(m, "IndirectFieldDecl" , py::base<clang::ValueDecl>())
        ...
        //.def("chain", (llvm::ArrayRef<clang::NamedDecl *> (clang::IndirectFieldDecl::*)() const)&clang::IndirectFieldDecl::chain)
        .def("getChainingSize", (unsigned int (clang::IndirectFieldDecl::*)() const)&clang::IndirectFieldDecl::getChainingSize)
        .def("getAnonField", (clang::FieldDecl * (clang::IndirectFieldDecl::*)() const)&clang::IndirectFieldDecl::getAnonField)
        .def("getVarDecl", (clang::VarDecl * (clang::IndirectFieldDecl::*)() const)&clang::IndirectFieldDecl::getVarDecl)
    ...
    py::class_<clang::TypeDecl, decl_deleter<clang::TypeDecl>::type>(m, "TypeDecl" , py::base<clang::NamedDecl>())
        ...
        .def("getTypeForDecl", (const clang::Type * (clang::TypeDecl::*)() const)&clang::TypeDecl::getTypeForDecl)
    ...
    py::class_<clang::TypedefNameDecl, decl_deleter<clang::TypedefNameDecl>::type>(m, "TypedefNameDecl" , py::base<clang::TypeDecl>())
        ...
        .def("getTypeSourceInfo", (clang::TypeSourceInfo * (clang::TypedefNameDecl::*)() const)&clang::TypedefNameDecl::getTypeSourceInfo)
        ...
        .def("getAnonDeclWithTypedefName", (clang::TagDecl * (clang::TypedefNameDecl::*)(bool) const)&clang::TypedefNameDecl::getAnonDeclWithTypedefName)
    ;
    ...
    py::class_<clang::TypeAliasDecl, decl_deleter<clang::TypeAliasDecl>::type>(m, "TypeAliasDecl" , py::base<clang::TypedefNameDecl>())
        ...
        .def("getDescribedAliasTemplate", (clang::TypeAliasTemplateDecl * (clang::TypeAliasDecl::*)() const)&clang::TypeAliasDecl::getDescribedAliasTemplate)
    ...
    py::class_<clang::TagDecl, decl_deleter<clang::TagDecl>::type>(m, "TagDecl" , py::base<clang::TypeDecl>())
        ...
        .def("getDefinition", (clang::TagDecl * (clang::TagDecl::*)() const)&clang::TagDecl::getDefinition)
        ...
        .def("getTypedefNameForAnonDecl", (clang::TypedefNameDecl * (clang::TagDecl::*)() const)&clang::TagDecl::getTypedefNameForAnonDecl)
        .def("setTypedefNameForAnonDecl", (void (clang::TagDecl::*)(clang::TypedefNameDecl *))&clang::TagDecl::setTypedefNameForAnonDecl)
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::TagDecl::*)() const)&clang::TagDecl::getQualifier)
        ...
        //.def("getTemplateParameterList", (clang::TemplateParameterList * (clang::TagDecl::*)(unsigned int) const)&clang::TagDecl::getTemplateParameterList)
    ...
    py::class_<clang::EnumDecl, decl_deleter<clang::EnumDecl>::type>(m, "EnumDecl" , py::base<clang::TagDecl>())
        ...
        .def("getDefinition", (clang::EnumDecl * (clang::EnumDecl::*)() const)&clang::EnumDecl::getDefinition)
        ...
        .def("getIntegerTypeSourceInfo", (clang::TypeSourceInfo * (clang::EnumDecl::*)() const)&clang::EnumDecl::getIntegerTypeSourceInfo)
        ...
        .def("getTemplateInstantiationPattern", (clang::EnumDecl * (clang::EnumDecl::*)() const)&clang::EnumDecl::getTemplateInstantiationPattern)
        .def("getInstantiatedFromMemberEnum", (clang::EnumDecl * (clang::EnumDecl::*)() const)&clang::EnumDecl::getInstantiatedFromMemberEnum)
        ...
        //.def("getMemberSpecializationInfo", (clang::MemberSpecializationInfo * (clang::EnumDecl::*)() const)&clang::EnumDecl::getMemberSpecializationInfo)
    ...
    py::class_<clang::RecordDecl, decl_deleter<clang::RecordDecl>::type>(m, "RecordDecl" , py::base<clang::TagDecl>())
        ...
        .def("getDefinition", (clang::RecordDecl * (clang::RecordDecl::*)() const)&clang::RecordDecl::getDefinition)
        ...
        .def("findFirstNamedDataMember", (const clang::FieldDecl * (clang::RecordDecl::*)() const)&clang::RecordDecl::findFirstNamedDataMember)
    ;
    ...
    py::class_<clang::BlockDecl, decl_deleter<clang::BlockDecl>::type>(m, "BlockDecl" , py::base<clang::Decl>())
        ...
        .def("getCompoundBody", (clang::CompoundStmt * (clang::BlockDecl::*)() const)&clang::BlockDecl::getCompoundBody)
        .def("getBody", (clang::Stmt * (clang::BlockDecl::*)() const)&clang::BlockDecl::getBody)
        ...
        .def("getSignatureAsWritten", (clang::TypeSourceInfo * (clang::BlockDecl::*)() const)&clang::BlockDecl::getSignatureAsWritten)
        //.def("parameters", [](const clang::BlockDecl& self) -> llvm::ArrayRef<clang::ParmVarDecl *> {
        //  return self.parameters();
        //})
        //.def("parameters", []( clang::BlockDecl& self) -> llvm::MutableArrayRef<clang::ParmVarDecl *> {
        //  return self.parameters();
        //})
        .def("param_empty", (bool (clang::BlockDecl::*)() const)&clang::BlockDecl::param_empty)
        .def("param_size", (unsigned long (clang::BlockDecl::*)() const)&clang::BlockDecl::param_size)
        ...
        //.def("captures", (llvm::ArrayRef<clang::BlockDecl::Capture> (clang::BlockDecl::*)() const)&clang::BlockDecl::captures)
        ...
        .def("getBlockManglingContextDecl", (clang::Decl * (clang::BlockDecl::*)() const)&clang::BlockDecl::getBlockManglingContextDecl)
    ...
    py::class_<clang::CapturedDecl, decl_deleter<clang::CapturedDecl>::type>(m, "CapturedDecl" , py::base<clang::Decl>())
        ...
        .def("getBody", (clang::Stmt * (clang::CapturedDecl::*)() const)&clang::CapturedDecl::getBody)
        ...
        .def("getParam", (clang::ImplicitParamDecl * (clang::CapturedDecl::*)(unsigned int) const)&clang::CapturedDecl::getParam)
        .def("setParam", (void (clang::CapturedDecl::*)(unsigned int, clang::ImplicitParamDecl *))&clang::CapturedDecl::setParam)
        //.def("parameters", [](const clang::CapturedDecl& self) -> llvm::ArrayRef<clang::ImplicitParamDecl *> {
        //  return self.parameters();
        //})
        //.def("parameters", []( clang::CapturedDecl& self) -> llvm::MutableArrayRef<clang::ImplicitParamDecl *> {
        //  return self.parameters();
        //})
        .def("getContextParam", (clang::ImplicitParamDecl * (clang::CapturedDecl::*)() const)&clang::CapturedDecl::getContextParam)
    ...
    py::class_<clang::ImportDecl, decl_deleter<clang::ImportDecl>::type>(m, "ImportDecl" , py::base<clang::Decl>())
        ...
        //.def("getImportedModule", (clang::Module * (clang::ImportDecl::*)() const)&clang::ImportDecl::getImportedModule)
    ...
    py::class_<clang::Stmt, stmt_deleter<clang::Stmt>::type>(m, "Stmt" )
        ...
        .def("IgnoreImplicit", (clang::Stmt * (clang::Stmt::*)())&clang::Stmt::IgnoreImplicit)
        .def("IgnoreContainers", (clang::Stmt * (clang::Stmt::*)(bool))&clang::Stmt::IgnoreContainers)
    ...
    py::class_<clang::LabelStmt, stmt_deleter<clang::LabelStmt>::type>(m, "LabelStmt" , py::base<clang::Stmt>())
        ...
        .def("getDecl", (clang::LabelDecl * (clang::LabelStmt::*)() const)&clang::LabelStmt::getDecl)
    ...
    py::class_<clang::IfStmt, stmt_deleter<clang::IfStmt>::type>(m, "IfStmt" , py::base<clang::Stmt>())
        ...
        .def("getConditionVariable", (clang::VarDecl * (clang::IfStmt::*)() const)&clang::IfStmt::getConditionVariable)
        .def("setConditionVariable", (void (clang::IfStmt::*)(const clang::ASTContext &, clang::VarDecl *))&clang::IfStmt::setConditionVariable)
        .def("getConditionVariableDeclStmt", (const clang::DeclStmt * (clang::IfStmt::*)() const)&clang::IfStmt::getConditionVariableDeclStmt)
        .def("getInit", []( clang::IfStmt& self) -> clang::Stmt * {
          return self.getInit();
        })
        .def("getInit", [](const clang::IfStmt& self) -> const clang::Stmt * {
          return self.getInit();
        })
        .def("setInit", (void (clang::IfStmt::*)(clang::Stmt *))&clang::IfStmt::setInit)
        ...
        .def("isConstexpr", (bool (clang::IfStmt::*)() const)&clang::IfStmt::isConstexpr)
        .def("setConstexpr", (void (clang::IfStmt::*)(bool))&clang::IfStmt::setConstexpr)
    ...
    py::class_<clang::SwitchStmt, stmt_deleter<clang::SwitchStmt>::type>(m, "SwitchStmt" , py::base<clang::Stmt>())
        ...
        .def("getConditionVariable", (clang::VarDecl * (clang::SwitchStmt::*)() const)&clang::SwitchStmt::getConditionVariable)
        ...
        .def("getConditionVariableDeclStmt", (const clang::DeclStmt * (clang::SwitchStmt::*)() const)&clang::SwitchStmt::getConditionVariableDeclStmt)
