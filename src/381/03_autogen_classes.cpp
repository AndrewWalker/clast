...
void autogenerated_classes_2(pybind11::module& m)
{
    ...
    py::class_<clang::DesignatedInitExpr, stmt_deleter<clang::DesignatedInitExpr>::type>(m, "DesignatedInitExpr" , py::base<clang::Expr>())
        ...
        //.def("designators", []( clang::DesignatedInitExpr& self) -> llvm::iterator_range<clang::DesignatedInitExpr::Designator *> {
        //  return self.designators();
        //})
        //.def("designators", [](const clang::DesignatedInitExpr& self) -> llvm::iterator_range<const clang::DesignatedInitExpr::Designator *> {
        //  return self.designators();
        //})
    ...
    py::class_<clang::CXXConstructorDecl, decl_deleter<clang::CXXConstructorDecl>::type>(m, "CXXConstructorDecl" , py::base<clang::CXXMethodDecl>())
        ...
        .def("getInheritedConstructor", (const clang::CXXConstructorDecl * (clang::CXXConstructorDecl::*)() const)&clang::CXXConstructorDecl::getInheritedConstructor)
        .def("setInheritedConstructor", (void (clang::CXXConstructorDecl::*)(const clang::CXXConstructorDecl *))&clang::CXXConstructorDecl::setInheritedConstructor)
