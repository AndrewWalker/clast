...
void autogenerated_classes_2(pybind11::module& m)
{
    ...
    py::class_<clang::CXXConstructorDecl, decl_deleter<clang::CXXConstructorDecl>::type>(m, "CXXConstructorDecl" , py::base<clang::CXXMethodDecl>())
        ...
        .def("getInheritedConstructor", [](const clang::CXXConstructorDecl& self) -> const clang::CXXConstructorDecl * {
           return  self.getInheritedConstructor();
        })
        .def("setInheritedConstructor", []( clang::CXXConstructorDecl& self, const clang::CXXConstructorDecl * BaseCtor)  {
             self.setInheritedConstructor(BaseCtor);
        })
