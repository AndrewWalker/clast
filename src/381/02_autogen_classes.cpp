...
void autogenerated_classes_1(pybind11::module& m)
{
    ...
    py::class_<clang::ForStmt, stmt_deleter<clang::ForStmt>::type>(m, "ForStmt" , py::base<clang::Stmt>())
        ...
        .def("getConditionVariable", (clang::VarDecl * (clang::ForStmt::*)() const)&clang::ForStmt::getConditionVariable)
        .def("setConditionVariable", (void (clang::ForStmt::*)(const clang::ASTContext &, clang::VarDecl *))&clang::ForStmt::setConditionVariable)
        .def("getConditionVariableDeclStmt", (const clang::DeclStmt * (clang::ForStmt::*)() const)&clang::ForStmt::getConditionVariableDeclStmt)
    ...
    py::class_<clang::GotoStmt, stmt_deleter<clang::GotoStmt>::type>(m, "GotoStmt" , py::base<clang::Stmt>())
        ...
        .def("getLabel", (clang::LabelDecl * (clang::GotoStmt::*)() const)&clang::GotoStmt::getLabel)
    ...
    py::class_<clang::ReturnStmt, stmt_deleter<clang::ReturnStmt>::type>(m, "ReturnStmt" , py::base<clang::Stmt>())
        ...
        .def("getNRVOCandidate", (const clang::VarDecl * (clang::ReturnStmt::*)() const)&clang::ReturnStmt::getNRVOCandidate)
    ...
    py::class_<clang::AsmStmt, stmt_deleter<clang::AsmStmt>::type>(m, "AsmStmt" , py::base<clang::Stmt>())
        ...
        .def("getOutputExpr", (const clang::Expr * (clang::AsmStmt::*)(unsigned int) const)&clang::AsmStmt::getOutputExpr)
        ...
        .def("getInputExpr", (const clang::Expr * (clang::AsmStmt::*)(unsigned int) const)&clang::AsmStmt::getInputExpr)
    ...
    py::class_<clang::GCCAsmStmt, stmt_deleter<clang::GCCAsmStmt>::type>(m, "GCCAsmStmt" , py::base<clang::AsmStmt>())
        ...
        //.def("getOutputIdentifier", (clang::IdentifierInfo * (clang::GCCAsmStmt::*)(unsigned int) const)&clang::GCCAsmStmt::getOutputIdentifier)
        ...
        //.def("getInputIdentifier", (clang::IdentifierInfo * (clang::GCCAsmStmt::*)(unsigned int) const)&clang::GCCAsmStmt::getInputIdentifier)
    ...
    py::class_<clang::MSAsmStmt, stmt_deleter<clang::MSAsmStmt>::type>(m, "MSAsmStmt" , py::base<clang::AsmStmt>())
        ...
        //.def("getAsmToks", (clang::Token * (clang::MSAsmStmt::*)())&clang::MSAsmStmt::getAsmToks)
    ...
    py::class_<clang::SEHExceptStmt, stmt_deleter<clang::SEHExceptStmt>::type>(m, "SEHExceptStmt" , py::base<clang::Stmt>())
        ...
        .def("getFilterExpr", (clang::Expr * (clang::SEHExceptStmt::*)() const)&clang::SEHExceptStmt::getFilterExpr)
        .def("getBlock", (clang::CompoundStmt * (clang::SEHExceptStmt::*)() const)&clang::SEHExceptStmt::getBlock)
    ...
    py::class_<clang::SEHFinallyStmt, stmt_deleter<clang::SEHFinallyStmt>::type>(m, "SEHFinallyStmt" , py::base<clang::Stmt>())
        ...
        .def("getBlock", (clang::CompoundStmt * (clang::SEHFinallyStmt::*)() const)&clang::SEHFinallyStmt::getBlock)
    ...
    py::class_<clang::SEHTryStmt, stmt_deleter<clang::SEHTryStmt>::type>(m, "SEHTryStmt" , py::base<clang::Stmt>())
        ...
        .def("getTryBlock", (clang::CompoundStmt * (clang::SEHTryStmt::*)() const)&clang::SEHTryStmt::getTryBlock)
        .def("getHandler", (clang::Stmt * (clang::SEHTryStmt::*)() const)&clang::SEHTryStmt::getHandler)
        .def("getExceptHandler", (clang::SEHExceptStmt * (clang::SEHTryStmt::*)() const)&clang::SEHTryStmt::getExceptHandler)
        .def("getFinallyHandler", (clang::SEHFinallyStmt * (clang::SEHTryStmt::*)() const)&clang::SEHTryStmt::getFinallyHandler)
    ...
    py::class_<clang::CapturedStmt, stmt_deleter<clang::CapturedStmt>::type>(m, "CapturedStmt" , py::base<clang::Stmt>())
        ...
        .def("getCapturedRecordDecl", (const clang::RecordDecl * (clang::CapturedStmt::*)() const)&clang::CapturedStmt::getCapturedRecordDecl)
    ...
    py::class_<clang::SourceManager>(m, "SourceManager" )
        ...
        //})
        //.def("getFileEntryForID", (const clang::FileEntry * (clang::SourceManager::*)(clang::FileID) const)&clang::SourceManager::getFileEntryForID)
        //.def("getFileEntryForSLocEntry", (const clang::FileEntry * (clang::SourceManager::*)(const clang::SrcMgr::SLocEntry &) const)&clang::SourceManager::getFileEntryForSLocEntry)
        ...
        .def("getCharacterData", (const char * (clang::SourceManager::*)(clang::SourceLocation, bool *) const)&clang::SourceManager::getCharacterData)
        ...
        .def("getSpellingColumnNumber", (unsigned int (clang::SourceManager::*)(clang::SourceLocation, bool *) const)&clang::SourceManager::getSpellingColumnNumber)
        .def("getExpansionColumnNumber", (unsigned int (clang::SourceManager::*)(clang::SourceLocation, bool *) const)&clang::SourceManager::getExpansionColumnNumber)
        .def("getPresumedColumnNumber", (unsigned int (clang::SourceManager::*)(clang::SourceLocation, bool *) const)&clang::SourceManager::getPresumedColumnNumber)
        ...
        .def("getSpellingLineNumber", (unsigned int (clang::SourceManager::*)(clang::SourceLocation, bool *) const)&clang::SourceManager::getSpellingLineNumber)
        .def("getExpansionLineNumber", (unsigned int (clang::SourceManager::*)(clang::SourceLocation, bool *) const)&clang::SourceManager::getExpansionLineNumber)
        .def("getPresumedLineNumber", (unsigned int (clang::SourceManager::*)(clang::SourceLocation, bool *) const)&clang::SourceManager::getPresumedLineNumber)
        .def("getBufferName", (const char * (clang::SourceManager::*)(clang::SourceLocation, bool *) const)&clang::SourceManager::getBufferName)
    ...
    py::class_<clang::ASTContext>(m, "ASTContext" )
        ...
        //.def("getAuxTargetInfo", (const clang::TargetInfo * (clang::ASTContext::*)() const)&clang::ASTContext::getAuxTargetInfo)
        ...
        //.def("getRawCommentForDeclNoCache", (clang::RawComment * (clang::ASTContext::*)(const clang::Decl *) const)&clang::ASTContext::getRawCommentForDeclNoCache)
        ...
        //.def("getInstantiatedFromStaticDataMember", (clang::MemberSpecializationInfo * (clang::ASTContext::*)(const clang::VarDecl *))&clang::ASTContext::getInstantiatedFromStaticDataMember)
        ...
        .def("getClassScopeSpecializationPattern", (clang::FunctionDecl * (clang::ASTContext::*)(const clang::FunctionDecl *))&clang::ASTContext::getClassScopeSpecializationPattern)
        ...
        .def("getInstantiatedFromUsingDecl", (clang::NamedDecl * (clang::ASTContext::*)(clang::UsingDecl *))&clang::ASTContext::getInstantiatedFromUsingDecl)
        ...
        .def("getInstantiatedFromUsingShadowDecl", (clang::UsingShadowDecl * (clang::ASTContext::*)(clang::UsingShadowDecl *))&clang::ASTContext::getInstantiatedFromUsingShadowDecl)
        .def("getInstantiatedFromUnnamedFieldDecl", (clang::FieldDecl * (clang::ASTContext::*)(clang::FieldDecl *))&clang::ASTContext::getInstantiatedFromUnnamedFieldDecl)
        ...
        .def("getPrimaryMergedDecl", (clang::Decl * (clang::ASTContext::*)(clang::Decl *))&clang::ASTContext::getPrimaryMergedDecl)
        ...
        .def("getTranslationUnitDecl", (clang::TranslationUnitDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getTranslationUnitDecl)
        .def("getExternCContextDecl", (clang::ExternCContextDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getExternCContextDecl)
        .def("getMakeIntegerSeqDecl", (clang::BuiltinTemplateDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getMakeIntegerSeqDecl)
        ...
        //.def("getExternalSource", (clang::ExternalASTSource * (clang::ASTContext::*)() const)&clang::ASTContext::getExternalSource)
        //.def("setASTMutationListener", (void (clang::ASTContext::*)(clang::ASTMutationListener *))&clang::ASTContext::setASTMutationListener)
        //.def("getASTMutationListener", (clang::ASTMutationListener * (clang::ASTContext::*)() const)&clang::ASTContext::getASTMutationListener)
        ...
        //.def("buildBuiltinTemplateDecl", (clang::BuiltinTemplateDecl * (clang::ASTContext::*)(clang::BuiltinTemplateKind, const clang::IdentifierInfo *) const)&clang::ASTContext::buildBuiltinTemplateDecl)
        .def("buildImplicitRecord", (clang::RecordDecl * (clang::ASTContext::*)(llvm::StringRef, clang::TagTypeKind) const)&clang::ASTContext::buildImplicitRecord)
        .def("buildImplicitTypedef", (clang::TypedefDecl * (clang::ASTContext::*)(clang::QualType, llvm::StringRef) const)&clang::ASTContext::buildImplicitTypedef)
        .def("getInt128Decl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getInt128Decl)
        .def("getUInt128Decl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getUInt128Decl)
        .def("getFloat128StubType", (clang::TypeDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getFloat128StubType)
        ...
        //.def("adjustFunctionType", (const clang::FunctionType * (clang::ASTContext::*)(const clang::FunctionType *, clang::FunctionType::ExtInfo))&clang::ASTContext::adjustFunctionType)
        ...
        .def("getcudaConfigureCallDecl", (clang::FunctionDecl * (clang::ASTContext::*)())&clang::ASTContext::getcudaConfigureCallDecl)
        ...
        //})
        //.def("getCanonicalTemplateSpecializationType", (clang::QualType (clang::ASTContext::*)(clang::TemplateName, const clang::TemplateArgument *, unsigned int) const)&clang::ASTContext::getCanonicalTemplateSpecializationType)
        ...
        //})
        //.def("getTemplateSpecializationTypeInfo", (clang::TypeSourceInfo * (clang::ASTContext::*)(clang::TemplateName, clang::SourceLocation, const clang::TemplateArgumentListInfo &, clang::QualType) const)&clang::ASTContext::getTemplateSpecializationTypeInfo)
        ...
        //.def("getNSObjectName", (clang::IdentifierInfo * (clang::ASTContext::*)())&clang::ASTContext::getNSObjectName)
        //.def("getNSCopyingName", (clang::IdentifierInfo * (clang::ASTContext::*)())&clang::ASTContext::getNSCopyingName)
        //.def("getMakeIntegerSeqName", (clang::IdentifierInfo * (clang::ASTContext::*)() const)&clang::ASTContext::getMakeIntegerSeqName)
        .def("getObjCInstanceType", (clang::QualType (clang::ASTContext::*)())&clang::ASTContext::getObjCInstanceType)
        .def("getObjCInstanceTypeDecl", (clang::TypedefDecl * (clang::ASTContext::*)())&clang::ASTContext::getObjCInstanceTypeDecl)
        ...
        //.def("getObjCPropertyImplDeclForPropertyDecl", (clang::ObjCPropertyImplDecl * (clang::ASTContext::*)(const clang::ObjCPropertyDecl *, const clang::Decl *) const)&clang::ASTContext::getObjCPropertyImplDeclForPropertyDecl)
        ...
        .def("getObjCIdDecl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getObjCIdDecl)
        .def("getObjCIdType", (clang::QualType (clang::ASTContext::*)() const)&clang::ASTContext::getObjCIdType)
        .def("getObjCSelDecl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getObjCSelDecl)
        .def("getObjCSelType", (clang::QualType (clang::ASTContext::*)() const)&clang::ASTContext::getObjCSelType)
        .def("getObjCClassDecl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getObjCClassDecl)
        .def("getObjCClassType", (clang::QualType (clang::ASTContext::*)() const)&clang::ASTContext::getObjCClassType)
        //.def("getObjCProtocolDecl", (clang::ObjCInterfaceDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getObjCProtocolDecl)
        .def("getBOOLDecl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getBOOLDecl)
        ...
        .def("getBuiltinVaListDecl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getBuiltinVaListDecl)
        .def("getBuiltinVaListType", (clang::QualType (clang::ASTContext::*)() const)&clang::ASTContext::getBuiltinVaListType)
        .def("getVaListTagDecl", (clang::Decl * (clang::ASTContext::*)() const)&clang::ASTContext::getVaListTagDecl)
        .def("getBuiltinMSVaListDecl", (clang::TypedefDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getBuiltinMSVaListDecl)
        ...
        .def("getCurrentKeyFunction", (const clang::CXXMethodDecl * (clang::ASTContext::*)(const clang::CXXRecordDecl *))&clang::ASTContext::getCurrentKeyFunction)
        ...
        //.def("getVTableContext", (clang::VTableContextBase * (clang::ASTContext::*)())&clang::ASTContext::getVTableContext)
        //.def("createMangleContext", (clang::MangleContext * (clang::ASTContext::*)())&clang::ASTContext::createMangleContext)
        ...
        //.def("getCanonicalNestedNameSpecifier", (clang::NestedNameSpecifier * (clang::ASTContext::*)(clang::NestedNameSpecifier *) const)&clang::ASTContext::getCanonicalNestedNameSpecifier)
        ...
        //.def("getAsArrayType", (const clang::ArrayType * (clang::ASTContext::*)(clang::QualType) const)&clang::ASTContext::getAsArrayType)
        //.def("getAsConstantArrayType", (const clang::ConstantArrayType * (clang::ASTContext::*)(clang::QualType) const)&clang::ASTContext::getAsConstantArrayType)
        //.def("getAsVariableArrayType", (const clang::VariableArrayType * (clang::ASTContext::*)(clang::QualType) const)&clang::ASTContext::getAsVariableArrayType)
        //.def("getAsIncompleteArrayType", (const clang::IncompleteArrayType * (clang::ASTContext::*)(clang::QualType) const)&clang::ASTContext::getAsIncompleteArrayType)
        //.def("getAsDependentSizedArrayType", (const clang::DependentSizedArrayType * (clang::ASTContext::*)(clang::QualType) const)&clang::ASTContext::getAsDependentSizedArrayType)
        ...
        //.def("FunctionTypesMatchOnNSConsumedAttrs", (bool (clang::ASTContext::*)(const clang::FunctionProtoType *, const clang::FunctionProtoType *))&clang::ASTContext::FunctionTypesMatchOnNSConsumedAttrs)
        ...
        //})
        //.def("getObjCMethodRedeclaration", (const clang::ObjCMethodDecl * (clang::ASTContext::*)(const clang::ObjCMethodDecl *) const)&clang::ASTContext::getObjCMethodRedeclaration)
        ...
        //.def("getObjContainingInterface", (const clang::ObjCInterfaceDecl * (clang::ASTContext::*)(const clang::NamedDecl *) const)&clang::ASTContext::getObjContainingInterface)
        .def("setBlockVarCopyInits", (void (clang::ASTContext::*)(clang::VarDecl *, clang::Expr *))&clang::ASTContext::setBlockVarCopyInits)
        .def("getBlockVarCopyInits", (clang::Expr * (clang::ASTContext::*)(const clang::VarDecl *))&clang::ASTContext::getBlockVarCopyInits)
        .def("CreateTypeSourceInfo", (clang::TypeSourceInfo * (clang::ASTContext::*)(clang::QualType, unsigned int) const)&clang::ASTContext::CreateTypeSourceInfo)
        .def("getTrivialTypeSourceInfo", (clang::TypeSourceInfo * (clang::ASTContext::*)(clang::QualType, clang::SourceLocation) const)&clang::ASTContext::getTrivialTypeSourceInfo)
        ...
        .def("getCopyConstructorForExceptionObject", (const clang::CXXConstructorDecl * (clang::ASTContext::*)(clang::CXXRecordDecl *))&clang::ASTContext::getCopyConstructorForExceptionObject)
        ...
        .def("getDefaultArgExprForConstructor", (clang::Expr * (clang::ASTContext::*)(const clang::CXXConstructorDecl *, unsigned int))&clang::ASTContext::getDefaultArgExprForConstructor)
        ...
        .def("getTypedefNameForUnnamedTagDecl", (clang::TypedefNameDecl * (clang::ASTContext::*)(const clang::TagDecl *))&clang::ASTContext::getTypedefNameForUnnamedTagDecl)
        ...
        .def("getDeclaratorForUnnamedTagDecl", (clang::DeclaratorDecl * (clang::ASTContext::*)(const clang::TagDecl *))&clang::ASTContext::getDeclaratorForUnnamedTagDecl)
        ...
        //.def("createMangleNumberingContext", (clang::MangleNumberingContext * (clang::ASTContext::*)() const)&clang::ASTContext::createMangleNumberingContext)
        ...
        //.def("getMaterializedTemporaryValue", (clang::APValue * (clang::ASTContext::*)(const clang::MaterializeTemporaryExpr *, bool))&clang::ASTContext::getMaterializedTemporaryValue)
    ...
    py::class_<clang::Expr, stmt_deleter<clang::Expr>::type>(m, "Expr" , py::base<clang::Stmt>())
        ...
        //.def("getObjCProperty", (const clang::ObjCPropertyRefExpr * (clang::Expr::*)() const)&clang::Expr::getObjCProperty)
        ...
        .def("getBestDynamicClassType", (const clang::CXXRecordDecl * (clang::Expr::*)() const)&clang::Expr::getBestDynamicClassType)
        //.def("skipRValueSubobjectAdjustments", (const clang::Expr * (clang::Expr::*)(llvm::SmallVectorImpl<const clang::Expr *> &, llvm::SmallVectorImpl<clang::SubobjectAdjustment> &) const)&clang::Expr::skipRValueSubobjectAdjustments)
    ;
    ...
    py::class_<clang::OpaqueValueExpr, stmt_deleter<clang::OpaqueValueExpr>::type>(m, "OpaqueValueExpr" , py::base<clang::Expr>())
        ...
        .def("getSourceExpr", (clang::Expr * (clang::OpaqueValueExpr::*)() const)&clang::OpaqueValueExpr::getSourceExpr)
    ;
    ...
    py::class_<clang::DeclRefExpr, stmt_deleter<clang::DeclRefExpr>::type>(m, "DeclRefExpr" , py::base<clang::Expr>())
        ...
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::DeclRefExpr::*)() const)&clang::DeclRefExpr::getQualifier)
        ...
        //.def("getTemplateArgs", (const clang::TemplateArgumentLoc * (clang::DeclRefExpr::*)() const)&clang::DeclRefExpr::getTemplateArgs)
    ...
    py::class_<clang::UnaryOperator, stmt_deleter<clang::UnaryOperator>::type>(m, "UnaryOperator" , py::base<clang::Expr>())
        ...
        .def("getSubExpr", (clang::Expr * (clang::UnaryOperator::*)() const)&clang::UnaryOperator::getSubExpr)
    ...
    py::class_<clang::OffsetOfExpr, stmt_deleter<clang::OffsetOfExpr>::type>(m, "OffsetOfExpr" , py::base<clang::Expr>())
        ...
        .def("getTypeSourceInfo", (clang::TypeSourceInfo * (clang::OffsetOfExpr::*)() const)&clang::OffsetOfExpr::getTypeSourceInfo)
    ...
    py::class_<clang::UnaryExprOrTypeTraitExpr, stmt_deleter<clang::UnaryExprOrTypeTraitExpr>::type>(m, "UnaryExprOrTypeTraitExpr" , py::base<clang::Expr>())
        ...
        .def("getArgumentTypeInfo", (clang::TypeSourceInfo * (clang::UnaryExprOrTypeTraitExpr::*)() const)&clang::UnaryExprOrTypeTraitExpr::getArgumentTypeInfo)
    ...
    py::class_<clang::MemberExpr, stmt_deleter<clang::MemberExpr>::type>(m, "MemberExpr" , py::base<clang::Expr>())
        ...
        .def("getBase", (clang::Expr * (clang::MemberExpr::*)() const)&clang::MemberExpr::getBase)
        .def("getMemberDecl", (clang::ValueDecl * (clang::MemberExpr::*)() const)&clang::MemberExpr::getMemberDecl)
        ...
        //.def("getQualifier", (clang::NestedNameSpecifier * (clang::MemberExpr::*)() const)&clang::MemberExpr::getQualifier)
        ...
        //.def("getTemplateArgs", (const clang::TemplateArgumentLoc * (clang::MemberExpr::*)() const)&clang::MemberExpr::getTemplateArgs)
    ...
    py::class_<clang::CompoundLiteralExpr, stmt_deleter<clang::CompoundLiteralExpr>::type>(m, "CompoundLiteralExpr" , py::base<clang::Expr>())
        ...
        .def("getTypeSourceInfo", (clang::TypeSourceInfo * (clang::CompoundLiteralExpr::*)() const)&clang::CompoundLiteralExpr::getTypeSourceInfo)
    ...
    py::class_<clang::ExplicitCastExpr, stmt_deleter<clang::ExplicitCastExpr>::type>(m, "ExplicitCastExpr" , py::base<clang::CastExpr>())
        ...
        .def("getTypeInfoAsWritten", (clang::TypeSourceInfo * (clang::ExplicitCastExpr::*)() const)&clang::ExplicitCastExpr::getTypeInfoAsWritten)
    ...
    py::class_<clang::BinaryOperator, stmt_deleter<clang::BinaryOperator>::type>(m, "BinaryOperator" , py::base<clang::Expr>())
        ...
        .def("getLHS", (clang::Expr * (clang::BinaryOperator::*)() const)&clang::BinaryOperator::getLHS)
        .def("setLHS", (void (clang::BinaryOperator::*)(clang::Expr *))&clang::BinaryOperator::setLHS)
        .def("getRHS", (clang::Expr * (clang::BinaryOperator::*)() const)&clang::BinaryOperator::getRHS)
    ...
    py::class_<clang::AbstractConditionalOperator, stmt_deleter<clang::AbstractConditionalOperator>::type>(m, "AbstractConditionalOperator" , py::base<clang::Expr>())
        ...
        .def("getCond", (clang::Expr * (clang::AbstractConditionalOperator::*)() const)&clang::AbstractConditionalOperator::getCond)
        .def("getTrueExpr", (clang::Expr * (clang::AbstractConditionalOperator::*)() const)&clang::AbstractConditionalOperator::getTrueExpr)
        .def("getFalseExpr", (clang::Expr * (clang::AbstractConditionalOperator::*)() const)&clang::AbstractConditionalOperator::getFalseExpr)
    ...
    py::class_<clang::ConditionalOperator, stmt_deleter<clang::ConditionalOperator>::type>(m, "ConditionalOperator" , py::base<clang::AbstractConditionalOperator>())
        ...
        .def("getCond", (clang::Expr * (clang::ConditionalOperator::*)() const)&clang::ConditionalOperator::getCond)
        .def("getTrueExpr", (clang::Expr * (clang::ConditionalOperator::*)() const)&clang::ConditionalOperator::getTrueExpr)
        .def("getFalseExpr", (clang::Expr * (clang::ConditionalOperator::*)() const)&clang::ConditionalOperator::getFalseExpr)
        .def("getLHS", (clang::Expr * (clang::ConditionalOperator::*)() const)&clang::ConditionalOperator::getLHS)
        .def("getRHS", (clang::Expr * (clang::ConditionalOperator::*)() const)&clang::ConditionalOperator::getRHS)
    ...
    py::class_<clang::BinaryConditionalOperator, stmt_deleter<clang::BinaryConditionalOperator>::type>(m, "BinaryConditionalOperator" , py::base<clang::AbstractConditionalOperator>())
        ...
        .def("getCommon", (clang::Expr * (clang::BinaryConditionalOperator::*)() const)&clang::BinaryConditionalOperator::getCommon)
        .def("getOpaqueValue", (clang::OpaqueValueExpr * (clang::BinaryConditionalOperator::*)() const)&clang::BinaryConditionalOperator::getOpaqueValue)
        .def("getCond", (clang::Expr * (clang::BinaryConditionalOperator::*)() const)&clang::BinaryConditionalOperator::getCond)
        .def("getTrueExpr", (clang::Expr * (clang::BinaryConditionalOperator::*)() const)&clang::BinaryConditionalOperator::getTrueExpr)
        .def("getFalseExpr", (clang::Expr * (clang::BinaryConditionalOperator::*)() const)&clang::BinaryConditionalOperator::getFalseExpr)
    ...
    py::class_<clang::AddrLabelExpr, stmt_deleter<clang::AddrLabelExpr>::type>(m, "AddrLabelExpr" , py::base<clang::Expr>())
        ...
        .def("getLabel", (clang::LabelDecl * (clang::AddrLabelExpr::*)() const)&clang::AddrLabelExpr::getLabel)
    ...
    py::class_<clang::ConvertVectorExpr, stmt_deleter<clang::ConvertVectorExpr>::type>(m, "ConvertVectorExpr" , py::base<clang::Expr>())
        ...
        .def("getSrcExpr", (clang::Expr * (clang::ConvertVectorExpr::*)() const)&clang::ConvertVectorExpr::getSrcExpr)
        .def("getTypeSourceInfo", (clang::TypeSourceInfo * (clang::ConvertVectorExpr::*)() const)&clang::ConvertVectorExpr::getTypeSourceInfo)
    ...
    py::class_<clang::ChooseExpr, stmt_deleter<clang::ChooseExpr>::type>(m, "ChooseExpr" , py::base<clang::Expr>())
        ...
        .def("getChosenSubExpr", (clang::Expr * (clang::ChooseExpr::*)() const)&clang::ChooseExpr::getChosenSubExpr)
        .def("getCond", (clang::Expr * (clang::ChooseExpr::*)() const)&clang::ChooseExpr::getCond)
        .def("setCond", (void (clang::ChooseExpr::*)(clang::Expr *))&clang::ChooseExpr::setCond)
        .def("getLHS", (clang::Expr * (clang::ChooseExpr::*)() const)&clang::ChooseExpr::getLHS)
        .def("setLHS", (void (clang::ChooseExpr::*)(clang::Expr *))&clang::ChooseExpr::setLHS)
        .def("getRHS", (clang::Expr * (clang::ChooseExpr::*)() const)&clang::ChooseExpr::getRHS)
    ...
    py::class_<clang::VAArgExpr, stmt_deleter<clang::VAArgExpr>::type>(m, "VAArgExpr" , py::base<clang::Expr>())
        ...
        .def("getWrittenTypeInfo", (clang::TypeSourceInfo * (clang::VAArgExpr::*)() const)&clang::VAArgExpr::getWrittenTypeInfo)
    ...
    py::class_<clang::InitListExpr, stmt_deleter<clang::InitListExpr>::type>(m, "InitListExpr" , py::base<clang::Expr>())
        ...
        .def("updateInit", (clang::Expr * (clang::InitListExpr::*)(const clang::ASTContext &, unsigned int, clang::Expr *))&clang::InitListExpr::updateInit)
        ...
        .def("getSemanticForm", (clang::InitListExpr * (clang::InitListExpr::*)() const)&clang::InitListExpr::getSemanticForm)
        .def("getSyntacticForm", (clang::InitListExpr * (clang::InitListExpr::*)() const)&clang::InitListExpr::getSyntacticForm)
