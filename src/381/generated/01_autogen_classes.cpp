...
void autogenerated_classes_0(pybind11::module& m)
{
    ...
    py::class_<clang::DeclarationNameInfo>(m, "DeclarationNameInfo" )
        ...
        //.def("getInfo", (const clang::DeclarationNameLoc & (clang::DeclarationNameInfo::*)() const)&clang::DeclarationNameInfo::getInfo  )
        //.def("getInfo", (clang::DeclarationNameLoc & (clang::DeclarationNameInfo::*)())&clang::DeclarationNameInfo::getInfo  )
    ...
    py::class_<clang::Decl, decl_deleter<clang::Decl>::type>(m, "Decl" )
        ...
        //.def("getAttrs", (llvm::SmallVector<clang::Attr *, 2> & (clang::Decl::*)())&clang::Decl::getAttrs  )
        //.def("getAttrs", (const llvm::SmallVector<clang::Attr *, 2> & (clang::Decl::*)() const)&clang::Decl::getAttrs  )
        ...
        //.def("print", (void (clang::Decl::*)(llvm::raw_ostream &, unsigned int, bool) const)&clang::Decl::print  )
        //.def("print", (void (clang::Decl::*)(llvm::raw_ostream &, const clang::PrintingPolicy &, unsigned int, bool) const)&clang::Decl::print  )
        .def("dump", [](const clang::Decl& self)  {
          self.dump();
        } )
        .def("dumpColor", (void (clang::Decl::*)() const)&clang::Decl::dumpColor  )
        //.def("dump", (void (clang::Decl::*)(llvm::raw_ostream &) const)&clang::Decl::dump  )
    ...
    py::class_<clang::DeclContext>(m, "DeclContext" )
        ...
        //.def("dumpLookups", (void (clang::DeclContext::*)(llvm::raw_ostream &, bool) const)&clang::DeclContext::dumpLookups  )
    ;
    ...
    py::class_<clang::Qualifiers>(m, "Qualifiers" )
        ...
        //.def("getAsString", (std::basic_string<char> (clang::Qualifiers::*)(const clang::PrintingPolicy &) const)&clang::Qualifiers::getAsString  )
    ...
    py::class_<clang::QualType>(m, "QualType" )
        ...
        //.def("getSplitDesugaredType", (clang::SplitQualType (clang::QualType::*)() const)&clang::QualType::getSplitDesugaredType  )
        ...
        //.def("getAsString", (std::basic_string<char> (clang::QualType::*)(const clang::PrintingPolicy &) const)&clang::QualType::getAsString  )
        //.def("print", (void (clang::QualType::*)(llvm::raw_ostream &, const clang::PrintingPolicy &, const llvm::Twine &) const)&clang::QualType::print  )
        //.def("getAsStringInternal", (void (clang::QualType::*)(std::basic_string<char> &, const clang::PrintingPolicy &) const)&clang::QualType::getAsStringInternal  )
    ...
    py::class_<clang::NamedDecl, decl_deleter<clang::NamedDecl>::type>(m, "NamedDecl" , py::base<clang::Decl>())
        ...
        //.def("printQualifiedName", (void (clang::NamedDecl::*)(llvm::raw_ostream &) const)&clang::NamedDecl::printQualifiedName  )
        //.def("printQualifiedName", (void (clang::NamedDecl::*)(llvm::raw_ostream &, const clang::PrintingPolicy &) const)&clang::NamedDecl::printQualifiedName  )
    ...
    py::class_<clang::VarDecl, decl_deleter<clang::VarDecl>::type>(m, "VarDecl" , py::base<clang::DeclaratorDecl>())
        ...
        //.def("evaluateValue", (clang::APValue * (clang::VarDecl::*)() const)&clang::VarDecl::evaluateValue , py::return_value_policy::reference_internal )
        //.def("evaluateValue", (clang::APValue * (clang::VarDecl::*)(llvm::SmallVectorImpl<std::pair<clang::SourceLocation, clang::PartialDiagnostic> > &) const)&clang::VarDecl::evaluateValue , py::return_value_policy::reference_internal )
    ...
    py::class_<clang::FunctionDecl, decl_deleter<clang::FunctionDecl>::type>(m, "FunctionDecl" , py::base<clang::DeclaratorDecl>())
        ...
        //.def("params", (llvm::iterator_range<clang::ParmVarDecl **> (clang::FunctionDecl::*)())&clang::FunctionDecl::params  )
        //.def("params", (llvm::iterator_range<clang::ParmVarDecl *const *> (clang::FunctionDecl::*)() const)&clang::FunctionDecl::params  )
        ...
        //.def("setParams", (void (clang::FunctionDecl::*)(llvm::ArrayRef<clang::ParmVarDecl *>))&clang::FunctionDecl::setParams  )
        ...
        //.def("setFunctionTemplateSpecialization", (void (clang::FunctionDecl::*)(clang::FunctionTemplateDecl *, const clang::TemplateArgumentList *, void *, clang::TemplateSpecializationKind, const clang::TemplateArgumentListInfo *, clang::SourceLocation))&clang::FunctionDecl::setFunctionTemplateSpecialization  )
    ...
    py::class_<clang::BlockDecl, decl_deleter<clang::BlockDecl>::type>(m, "BlockDecl" , py::base<clang::Decl>())
        ...
        //.def("params", (llvm::iterator_range<clang::ParmVarDecl **> (clang::BlockDecl::*)())&clang::BlockDecl::params  )
        //.def("params", (llvm::iterator_range<clang::ParmVarDecl *const *> (clang::BlockDecl::*)() const)&clang::BlockDecl::params  )
        ...
        //.def("captures", (llvm::iterator_range<const clang::BlockDecl::Capture *> (clang::BlockDecl::*)())&clang::BlockDecl::captures  )
        //.def("captures", (llvm::iterator_range<const clang::BlockDecl::Capture *> (clang::BlockDecl::*)() const)&clang::BlockDecl::captures  )
    ...
    py::class_<clang::Stmt, stmt_deleter<clang::Stmt>::type>(m, "Stmt" )
        ...
        //.def("dump", (void (clang::Stmt::*)(llvm::raw_ostream &, clang::SourceManager &) const)&clang::Stmt::dump  )
        //.def("dump", (void (clang::Stmt::*)(llvm::raw_ostream &) const)&clang::Stmt::dump  )
        ...
        //.def("children", (llvm::iterator_range<clang::StmtIterator> (clang::Stmt::*)())&clang::Stmt::children  )
        //.def("children", (llvm::iterator_range<clang::ConstStmtIterator> (clang::Stmt::*)() const)&clang::Stmt::children  )
    ...
    py::class_<clang::DeclStmt, stmt_deleter<clang::DeclStmt>::type>(m, "DeclStmt" , py::base<clang::Stmt>())
        ...
        //.def("getDeclGroup", (const clang::DeclGroupRef (clang::DeclStmt::*)() const)&clang::DeclStmt::getDeclGroup  )
        //.def("getDeclGroup", (clang::DeclGroupRef (clang::DeclStmt::*)())&clang::DeclStmt::getDeclGroup  )
        ...
        //.def("decls", (llvm::iterator_range<clang::Decl **> (clang::DeclStmt::*)())&clang::DeclStmt::decls  )
        //.def("decls", (llvm::iterator_range<clang::Decl *const *> (clang::DeclStmt::*)() const)&clang::DeclStmt::decls  )
    ;
    ...
    py::class_<clang::CompoundStmt, stmt_deleter<clang::CompoundStmt>::type>(m, "CompoundStmt" , py::base<clang::Stmt>())
        ...
        //.def("body", (llvm::iterator_range<clang::Stmt **> (clang::CompoundStmt::*)())&clang::CompoundStmt::body  )
        ...
        //.def("body", (llvm::iterator_range<clang::Stmt *const *> (clang::CompoundStmt::*)() const)&clang::CompoundStmt::body  )
        ...
        //.def("children", (llvm::iterator_range<clang::StmtIterator> (clang::CompoundStmt::*)())&clang::CompoundStmt::children  )
        //.def("children", (llvm::iterator_range<clang::ConstStmtIterator> (clang::CompoundStmt::*)() const)&clang::CompoundStmt::children  )
    ;
