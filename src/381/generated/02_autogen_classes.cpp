...
void autogenerated_classes_1(pybind11::module& m)
{
    ...
    py::class_<clang::SourceManager>(m, "SourceManager" )
        ...
        //.def("getExpansionRange", (std::pair<clang::SourceLocation, clang::SourceLocation> (clang::SourceManager::*)(clang::SourceLocation) const)&clang::SourceManager::getExpansionRange  )
    ...
    py::class_<clang::ASTContext>(m, "ASTContext" )
        ...
        .def("getFloat128StubType", (clang::TypeDecl * (clang::ASTContext::*)() const)&clang::ASTContext::getFloat128StubType , py::return_value_policy::reference_internal )
        ...
        //.def("getTemplateSpecializationType", (clang::QualType (clang::ASTContext::*)(clang::TemplateName, const clang::TemplateArgument *, unsigned int, clang::QualType) const)&clang::ASTContext::getTemplateSpecializationType  )
        ...
        //.def("getDependentTemplateSpecializationType", (clang::QualType (clang::ASTContext::*)(clang::ElaboratedTypeKeyword, clang::NestedNameSpecifier *, const clang::IdentifierInfo *, unsigned int, const clang::TemplateArgument *) const)&clang::ASTContext::getDependentTemplateSpecializationType  )
