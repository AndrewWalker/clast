...
void autogenerated_classes_2(pybind11::module& m)
{
    ...
    py::class_<clang::DesignatedInitExpr, stmt_deleter<clang::DesignatedInitExpr>::type>(m, "DesignatedInitExpr" , py::base<clang::Expr>())
        ...
        //.def("designators", (llvm::iterator_range<clang::DesignatedInitExpr::Designator *> (clang::DesignatedInitExpr::*)())&clang::DesignatedInitExpr::designators  )
        //.def("designators", (llvm::iterator_range<const clang::DesignatedInitExpr::Designator *> (clang::DesignatedInitExpr::*)() const)&clang::DesignatedInitExpr::designators  )
    ...
    py::class_<clang::CXXConstructorDecl, decl_deleter<clang::CXXConstructorDecl>::type>(m, "CXXConstructorDecl" , py::base<clang::CXXMethodDecl>())
        ...
        .def("getInheritedConstructor", (const clang::CXXConstructorDecl * (clang::CXXConstructorDecl::*)() const)&clang::CXXConstructorDecl::getInheritedConstructor , py::return_value_policy::reference_internal )
